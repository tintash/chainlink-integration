...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        const oraclerequestParams= [
            ...
            const errorOracleRequestParams = [...oraclerequestParams];
            errorOracleRequestParams[1]= types.uint(0);
        
        let block = chain.mineBlock([

            //First correct request and expecting (ok true)
            Tx.contractCall("oracle", "oracle-request", oraclerequestParams, wallet1Address),

           //Checking that reuest count is u1
            Tx.contractCall("oracle", "get-request-count", [], wallet1Address),

            //Expecting u10 error while sending u0 STX
            Tx.contractCall("oracle", "oracle-request", errorOracleRequestParams, wallet1Address),
        ...
        block = chain.mineBlock([
            ...
            Tx.contractCall("oracle", "get-request-count", [], wallet2Address),
            ...
            Tx.contractCall("oracle", "fullfill-oracle-request", wrongRequestIdFulfillmentRequestParams, wallet1Address),
            ...
            Tx.contractCall("oracle", "fullfill-oracle-request", wrongExpirationFulfillmentRequestParams, wallet1Address),
            ...
            Tx.contractCall("oracle", "fullfill-oracle-request", fulfillmentRequestParams, wallet1Address),
        ]);
